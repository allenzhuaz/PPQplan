...
[![Travis build status](https://travis-ci.org/allenzhuaz/PPQplan.svg?branch=master)](https://travis-ci.org/allenzhuaz/PPQplan)
...
Open R console, install the pacakge directly from [CRAN](https://cran.r-project.org/web/packages/PPQplan/index.html):
