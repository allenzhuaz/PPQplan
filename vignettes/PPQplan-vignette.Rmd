...
#### `PPQ_pp`: calcualtes the probability of passing some critical quality attributes (CQA) PPQ test using a general constant multiplier `k`. 
...
#### `pi_pp`: calcualtes the probability of passing the PPQ test using prediction interval with confidence level $100 \times 1-\alpha$.  
...
#### `ti_pp`: calcualtes the probability of passing the PPQ test using one-sided or two-sided tolerance interval with confidence level $100 \times 1-\alpha$.  
